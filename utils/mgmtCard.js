function mgmtMarkdown(data) {
  ...
  <div class="row">
    <div class="jumbotron">
      <h1 class="display-4 container-fluid text-center jumbo">My Team</h1>
    </div>
  </div> 
  <div class="row text-center mgmtCard">
    ...
    <div class="card shadow-lg p-3 mb-5 bg-white rounded" style="width: 18rem;" >
      <div class="card-body">
        ...
        <h5 class="card-text role" >Manager</h5>
      </div>
      <ul class="list-group list-group-flush">
        <li class="list-group-item">ID: ${data.identification}</li>
  ...
  <div class="row text-center engineerCard">
  
  </div> 
  <div class="row text-center internCard">
